...
const View = dynamic(() => import('@/components/canvas/View').then((mod) => mod.View), {
  ...
  loading: () => (
    <div className='flex flex-col items-center justify-center w-full h-96'>
      <svg className='mr-3 -ml-1 text-black size-5 animate-spin' fill='none' viewBox='0 0 24 24'>
...
export default function Page() {
  return (
    <>
      ...
      <View className='absolute top-0 flex h-screen w-full flex-col items-center justify-center bg-[#s2563eb]'>
        <Blob />
        <Common />
      </View>
    </>
